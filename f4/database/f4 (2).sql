...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 18, 2023 at 03:30 PM
...
INSERT INTO `bookingpackage` (`booking_id`, `ref_num`, `user_id`, `package_id`, `check_in_date`, `check_out_date`, `total_amount`, `order_date`) VALUES
(1, '69S5S3W6', 1, 2, '2023-12-05', '2023-12-05', 1770, '2023-12-05 07:03:36'),
(2, '56R0B4M4', 3, 5, '2023-12-30', '2023-12-31', 2400, '2023-12-05 07:06:20'),
(3, '42G5Y6H8', 1, 3, '2023-12-05', '2023-12-05', 1050, '2023-12-05 08:28:09'),
(4, '50B4F2V3', 1, 3, '2023-12-18', '2023-12-18', 1050, '2023-12-18 12:39:10');
...
INSERT INTO `package` (`package_id`, `package_name`, `description`, `type_of_package`, `combopackage_id`, `location_id`, `package_cost`, `status`) VALUES
(2, 'Albay All-day Tour', 'Explore the rich cultural tapestry and natural wonders of Albay with our All-Day Tour. Immerse youself in the local charm as you traverse through vibrant landscapes and witness the region\'s diverse heritage. Engage in a day filled with captivating experiences, from cultural encounters to scenic marvels. Our Albay All-Day Tour promises an unforgettable journey, unveiling the hidden gems and stories that make this destination truly special. Join us for a day of discovery and create lasting memories in the heart of Albay.', 'tour', 1, 1, 1750, 'A'),
(3, 'Sumlang Lake Tour Package', 'This bountiful lake offers and unhindered view of Mt.Mayon. It has now become an Instagram-worthy attraction. Not much to do here except for the activities mentioned on the below, but it has a relaxing atmosphere as it is surrounded by greenery.', 'package', 2, 1, 1000, 'A'),
(4, 'Camalig Ruins Tour Package', 'Just outside the town proper of Daraga, Albay, lies th belfry of a 16th century church that was destroyed as Mayon had its most violent eruption in recorded history on Feb 1, 1814\r\n\r\nToday, the remains of the church (bell tower) is famous to thousands of tourist, both local and international, as it is set against the magnificent backdrop, the Mayon Volcano.', 'package', 3, 1, 1000, 'A'),
(5, 'Albay Adventure Package', 'Embark on an exhilarating journey with our Albay Adventure Package, a curated experience that blends nature\'s beauty and thrilling activities. Discover the picturesque landscapes of Albay while engaging in adrenaline-pumping adventures. From exploring volcanic wonders to embracing the vibrant local culture, this package offers a perfect blend of excitement and relaxation. Immerse yourself in the unique charm of Albay through outdoor activities and cultural encounters, creating memories that linger long after the adventure concludes. Albay Adventure Package - where every moment is a new discovery and every experience is an adventure.', 'adventure', 1, 1, 2250, 'A');
